...
use Illuminate\Support\Facades\File; // Sadece klasör kontrolü/silme için kaldı
use Illuminate\Support\Facades\Storage; // GÜNCELLEME: Storage facade'ını tekrar kullanacağız (ama private disk için)
use Illuminate\Validation\Rule;
use Symfony\Component\HttpFoundation\StreamedResponse; // Dosya sunumu için
use Symfony\Component\HttpFoundation\Response; // Abort için

class PaymentController extends Controller
{
    // index() metodu aynı kalıyor...
    ...
    // show() metodu (Admin inceleme sayfası) aynı kalıyor...
    ...
    // update() metodu (Admin onay/red) aynı kalıyor...
