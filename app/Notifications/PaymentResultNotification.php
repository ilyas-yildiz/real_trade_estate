...
class PaymentResultNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'message' => number_format($this->amount, 2, ',', '.') . ' TL tutarındaki ödeme bildiriminiz ' . ($isApproved ? 'ONAYLANDI.' : 'REDDEDİLDİ.'),
            'link' => route('admin.payments.index'), // Müşteri tıklayınca kendi listesine gitsin
