<div class="table-responsive">
    <table class="table table-bordered align-middle table-nowrap mb-0">
        ...
        <tr>
            ...
            <th scope="col">Proje Başlığı</th> {{-- Güncellendi --}}
            <th scope="col">Müşteri</th> {{-- Eklendi --}}
        ...
        @empty
             {{-- Colspan güncellendi --}}
            <tr><td colspan="7" class="text-center">Henüz hiç proje eklenmemiş.</td></tr>
        @endforelse
        </tbody>
    </table>
</div>